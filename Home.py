...
for index,row in dff.iterrows():
    with st.expander(row['Naziv ']):
        ...
        a = str(row['Životna_dob2'])[0].upper()+str(row['Životna_dob2'])[1:]
        st.markdown('<p style="margin-top:10px;display:inline;float:left" class="blog-label">'+str(row['Usluga'])+'</p><p style="margin-left:5px;margin-top:10px;display:inline;float:left" class="blog-label">'+str(a)+'</p>', unsafe_allow_html=True)
